...
import MarkdownContent, { P, Tags } from '../file-editor/MarkdownContent';
...
const TrueSeeker: React.FC = () => {
  return (
    <FileEditor>
      ...
      <MarkdownContent>
        <Tags tags={[`Bahá'i / Writings`, 'Quotes']} />
        <P>
          ...
          abiding love of the Beloved, of every defilement, and sanctify his
          soul from all that pertaineth to water and clay, from all shadowy and
        ...
        <P>
          ...
          devoureth both heart and soul. The force of the former lasteth but for
        ...
        <P>
          ...
          should be content with little, and be freed from all inordinate
          desire. He should treasure the companionship of them that have
          renounced the world, and regard avoidance of boastful and worldly
          people a precious benefit. At the dawn of every day he should commune
          with God, and, with all his soul, persevere in the quest of his
          Beloved. He should consume every wayward thought with the flame of His
          loving mention, and, with the swiftness of lightning, pass by all else
          save Him. He should succor the dispossessed, and never withhold his
          favor from the destitute. He should show kindness to animals, how much
          more unto his fellow-man, to him who is endowed with the power of
          utterance. He should not hesitate to offer up his life for his
          Beloved, nor allow the censure of the people to turn him away from the
          ...
          he should avoid fellowship with evil-doers, and pray for the remission
          of their sins. He should forgive the sinful, and never despise his low
          ...
          Concourse on high! And how often hath a devout believer, at the hour
          of his soul’s ascension, been so changed as to fall into the
          nethermost fire! Our purpose in revealing these convincing and weighty
          utterances is to impress upon the seeker that he should regard all
          else beside God as transient, and count all things save Him, Who is
          the Object of all adoration, as utter nothingness. These are among the
          attributes of the exalted, and constitute the hall-mark of the
          spiritually-minded. They have already been mentioned in connection
          with the requirements of the wayfarers that tread the path of Positive
          Knowledge. When the detached wayfarer and sincere seeker hath
          ...
          implied in the verse: “Whoso maketh efforts for Us,” he shall enjoy
          the blessings conferred by the words: “In Our Ways shall We assuredly
          guide him.” Only when the lamp of search, of earnest striving, of
          longing desire, of passionate devotion, of fervid love, of rapture,
          and ecstasy, is kindled within the seeker’s heart, and the breeze of
          ...
          such new life upon the seeker that he will find himself endowed with a
          new eye, a new ear, a new heart, and a new mind. He will contemplate
          the manifest signs of the universe, and will penetrate the hidden
          mysteries of the soul. Gazing with the eye of God, he will perceive
          ...
          Revelation, and the evidences of an everlasting Manifestation. I swear
          by God! Were he that treadeth the path of guidance and seeketh to
          ...
          across immeasurable distances, and will, led by its perfume, attain
          and enter the City of Certitude. Therein he will discern the wonders
          of His ancient Wisdom, and will perceive all the hidden teachings from
          the rustling leaves of the Tree that flourisheth in that City. With
          both his inner and outer ear, he will hear from its dust the hymns of
          glory and praise ascending unto the Lord of Lords, and with his inner
          eye will he discover the mysteries of “return” and “revival.”
        </P>
        ...
        <P>
          ...
          will hearken unto infallible proofs from the Hyacinth of that
          assembly, and will receive the surest testimonies from the beauty of
          its Rose, and the melody of its Nightingale. Once in about a thousand
        ...
        <P>
          ...
          of Jesus, the Gospel; in the days of Muḥammad, the Messenger of God,
          the Qur’án; in this day, the Bayán; and in the Dispensation of Him
          Whom God will make manifest, His own Book—the Book unto which all the
          Books of former Dispensations must needs be referred, the Book that
