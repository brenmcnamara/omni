...
const TrueSeeker: React.FC = () => {
  return (
    <FileEditor>
      <FileEditorTitle title="True Seeker" />
      <FileEditorTags tags={[`Bahá'i / Writings`, 'Quotes']} />
      <P>
        O My brother! When a true seeker determineth to take the step of search
        in the path leading unto the knowledge of the Ancient of Days, he must,
        before all else, cleanse his heart, which is the seat of the revelation
        of the inner mysteries of God, from the obscuring dust of all acquired
        knowledge, and the allusions of the embodiments of satanic fancy. He
      ...
      <P>
        ...
        observe silence and refrain from idle talk. For the tongue is a
        smoldering fire, and excess of speech a deadly poison. Material fire
        ...
        effects of the latter endureth a century.
      </P>
      ...
      <P>
        ...
        soul, persevere in the quest of his Beloved. He should consume every
        wayward thought with the flame of His loving mention, and, with the
        swiftness of lightning, pass by all else save Him. He should succor the
        dispossessed, and never withhold his favor from the destitute. He should
        show kindness to animals, how much more unto his fellow-man, to him who
        is endowed with the power of utterance. He should not hesitate to offer
        up his life for his Beloved, nor allow the censure of the people to turn
        him away from the Truth. He should not wish for others that which he
        doth not wish for himself, nor promise that which he doth not fulfil.
        With all his heart he should avoid fellowship with evil-doers, and pray
        for the remission of their sins. He should forgive the sinful, and never
        despise his low estate, for none knoweth what his own end shall be. How
        often hath a sinner attained, at the hour of death, to the essence of
        faith, and, quaffing the immortal draught, hath taken his flight unto
        the Concourse on high! And how often hath a devout believer, at the hour
        of his soul’s ascension, been so changed as to fall into the nethermost
        fire! Our purpose in revealing these convincing and weighty utterances
        is to impress upon the seeker that he should regard all else beside God
        as transient, and count all things save Him, Who is the Object of all
        adoration, as utter nothingness. These are among the attributes of the
        exalted, and constitute the hall-mark of the spiritually-minded. They
        have already been mentioned in connection with the requirements of the
        wayfarers that tread the path of Positive Knowledge. When the detached
        wayfarer and sincere seeker hath fulfilled these essential conditions,
        then and only then can he be called a true seeker. Whensoever he hath
        fulfilled the conditions implied in the verse: “Whoso maketh efforts for
        Us,” he shall enjoy the blessings conferred by the words: “In Our Ways
        shall We assuredly guide him.” Only when the lamp of search, of earnest
        striving, of longing desire, of passionate devotion, of fervid love, of
        rapture, and ecstasy, is kindled within the seeker’s heart, and the
        breeze of His loving-kindness is wafted upon his soul, will the darkness
        of error be dispelled, the mists of doubts and misgivings be dissipated,
        and the lights of knowledge and certitude envelop his being. At that
        hour will the Mystic Herald, bearing the joyful tidings of the Spirit,
        shine forth from the City of God resplendent as the morn, and, through
        the trumpet-blast of knowledge, will awaken the heart, the soul, and the
        ...
        evidences of an everlasting Manifestation. I swear by God! Were he that
        treadeth the path of guidance and seeketh to scale the heights of
        righteousness to attain unto this glorious and exalted station, he would
        inhale, at a distance of a thousand leagues, the fragrance of God, and
        would perceive the resplendent morn of a Divine guidance rising above
        the Day Spring of all things. Each and every thing, however small, would
        be to him a revelation, leading him to his Beloved, the Object of his
        ...
        the sun from shadow. If in the uttermost corners of the East the sweet
        savors of God be wafted, he will assuredly recognize and inhale their
        ...
        utterances, His great works, and mighty deeds—from the doings, the words
        and ways of men, even as the jeweler who knoweth the gem from the stone,
        or the man who distinguisheth the spring from autumn, and heat from
        ...
        teachings from the rustling leaves of the Tree that flourisheth in that
        City. With both his inner and outer ear, he will hear from its dust the
        hymns of glory and praise ascending unto the Lord of Lords, and with his
        inner eye will he discover the mysteries of “return” and “revival.”
      </P>

      <P>
        How unspeakably glorious are the signs, the tokens, the revelations, and
        splendors which He, Who is the King of Names and Attributes, hath
      ...
      <P>
        ...
        and will receive the surest testimonies from the beauty of its Rose, and
        the melody of its Nightingale. Once in about a thousand years shall this
        City be renewed and readorned….
      </P>
